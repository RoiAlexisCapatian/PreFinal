...
<body style="display: flex; justify-content: center;">
    <div class="paper">
        ...
        <div class="col_2">
            <img style="width: 200px; border: 1px solid; align-self: center;" src="{{ asset('storage/2x2.jpg') }}" alt="Image">
            ...
            <p class="bold">{{ json_decode($resume->education)->{1} }}</p>
            <p class="bold">{{ json_decode($resume->education)->{2} }}</p>
            <p class="bold">{{ json_decode($resume->education)->{3} }}</p>
            <div style="width: 100%;  border: 1px solid;"></div>
