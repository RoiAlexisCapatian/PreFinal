...
<body style="display: flex; justify-content: center;">
    <div class="paper">
        ...
        <div class="col_2">
            <!-- <img style="width: 200px; border: 1px solid; align-self: center;" src="laravel/storage/app/public/2x2.jpg" alt="Image"> -->
            ...
            <p class="bold"><?php echo e(json_decode($resume->work_history)->{1}); ?></p>
        </div>
    </div>
</body>
